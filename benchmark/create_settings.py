...
default_update = {
    ...
    "temperature_kirkpatrick_sigma": True,
    "core_temperature_kirkpatrick_sigma": True,
    "core_alpha": 0.99,
    "alpha": 0.99,
    "init_T_by_std": True,
...
new_dicts = [
    {"core_energy.scaling_model": "MLP"},
    {"core_energy.scaling_model": "maxC"},
    {"core_energy.scaling_model": "LHZ"},
    {"core_energy.scaling_for_plaq4": 0, "core_energy.scaling_model": None},
    {"core_energy.scaling_for_plaq4": 100, "core_energy.scaling_model": None},
...
new_dicts = [
    ...
    {"core_repetition_rate_factor": 8},
    {"core_temperature_adaptive": True, "core_temperature_kirkpatrick_sigma": False},
    {"core_temperature_kirkpatrick": True, "core_temperature_kirkpatrick_sigma": False},
    {"core_linear_in_moves": True, "core_temperature_kirkpatrick_sigma": False},
    {"core_temperature_C": True, "core_temperature_kirkpatrick_sigma": False},
    {"core_temperature_linearC": True, "core_temperature_kirkpatrick_sigma": False},
...
new_dicts = [
    ...
    },
    {
        ...
        "energy.bad_line_penalty": 50,
    },
    {"energy.subset_weight": False},
    {"energy.subset_weight": True},
    {"energy.exponential_scaling": 0},
    {"energy.exponential_scaling": 0.5},
    {"energy.exponential_scaling": 1},
    {"energy.exponential_scaling": 1.5},
    {"energy.exponential_scaling": 2},
    {"energy.exponential_scaling": 4},
    {"energy.exponential_scaling": 0.5, "scaling_for_plaq3": 1000, "scaling_for_plaq4": 1000},
    {"energy.exponential_scaling": 2, "scaling_for_plaq3": 1000, "scaling_for_plaq4": 1000},
...
new_dicts = [
    ...
    {"temperature_adaptive": True, "temperature_kirkpatrick_sigma": False},
    {"temperature_kirkpatrick": True, "temperature_kirkpatrick_sigma": False},
    {"linear_in_moves": True, "temperature_kirkpatrick_sigma": False},
    {"temperature_C": True, "temperature_kirkpatrick_sigma": False},
    {"temperature_linearC": True, "temperature_kirkpatrick_sigma": False},
